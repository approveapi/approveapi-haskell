## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `ApproveAPISwagger`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the ApproveAPISwagger API.
...
| configType                      | Set the name of the type used for configuration                                                                               |          | ApproveApiConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | ApproveApiRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| ApproveApi.Client    | use the "dispatch" functions to send requests       |
| ApproveApi.Core      | core funcions, config and request types             |
| ApproveApi.API       | construct api requests                              |
| ApproveApi.Model     | describes api models                                |
| ApproveApi.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| ApproveApi.ModelLens | lenses for model fields                             |
| ApproveApi.Logging   | logging functions and utils                         |
